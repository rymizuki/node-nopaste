...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('nopaste', '<nopaste-header> <h1>No Paste!</h1> </nopaste-header> <nopaste-form></nopaste-form> <nopaste-result result="{result}"></nopaste-result>', '', '', function (opts) {
	  this.onChangeState = function () {
	    var state = _app2.default.store.getState();
	    this.update(state);
	  }.bind(this);

	  this.onMount = function () {
	    _app2.default.subscribe(this.onChangeState);
	    var state = _app2.default.store.getState();
	    this.update(state);
	  }.bind(this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _syntagme = __webpack_require__(5);
	...
	var app = (0, _syntagme2.default)();

	app.reducer(_content2.default);
	app.reducer(_result2.default);
	...
	function contentReducer(_ref) {
	  ...
	  switch (action.type) {
	    ...
	    case 'UPDATE_TITLE':
	      ...
	      return Object.assign({}, previous, { content: content });
	    case 'UPDATE_TEXT':
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ac = _interopRequireWildcard(_actionCreator);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	riot.tag2('nopaste-form', '<form class="container-fluid"> <div class="form-group"> <label for="title">title</label> <input class="form-control" type="text" id="title" name="title" onkeyup="{updateTitle}"> </div> <div class="form-group"> <label for="text">text</label> <textarea class="form-control" name="text" id="text" rows="10" onkeyup="{updatetext}"></textarea> </div> <button class="btn btn-primary" type="button" onclick="{submit}">submit</button> </form>', '', '', function (opts) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function updateTitle(title) {
	  _app2.default.ac('UPDATE_TITLE', { title: title });
	}

	function updatetext(text) {
	  _app2.default.ac('UPDATE_TEXT', { text: text });
	}

	function submit(title, text) {
	  _app2.default.ac('SUBMIT_TEXT', function () {
	    return (0, _content.save)({ title: title, text: text });
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qwest = __webpack_require__(11);
	...
	function save(_ref) {
	  ...
	  return _qwest2.default.post('/api/content', {
	    title: title,
	    text: text
	  }, { dataType: 'json' }).then(function (xhr, response) {
	    return response;
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function() {
		...
		var global = window || this,
			pinkyswear = __webpack_require__(12),
			jparam = __webpack_require__(16),
			defaultOptions = {},
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(13)(module), __webpack_require__(14).setImmediate, __webpack_require__(15)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionCreator = __webpack_require__(18);

	var ac = _interopRequireWildcard(_actionCreator);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	riot.tag2('nopaste-result', '<div class="modal" riot-style="display: {result ? \'block\' : \'none\'}"> <div class="modal-dialog"> <div class="modal-content"> <div class="modal-header"> <button class="close" type="button" onclick="{close}"><span>&times;</span></button> <h4 class="modal-title">{result.content.title}</h4> </div> <div class="modal-body"> <pre>http://{location.host}/#post/{result.content.id}</pre> </div> <div class="modal-footer"> <button class="btn btn-default" onclick="{close}">close</button> </div> </div> </div> </div>', '', '', function (opts) {
	  this.close = function () {
	    ac.close();
	  }.bind(this);
	});
